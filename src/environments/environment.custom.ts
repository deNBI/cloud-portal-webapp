...
export const environment: any = {
	...
	invitation_group_post: `&targetexisting=https://signup.aai.lifescience-ri.eu/fed/registrar/vo=${VO_NAME}&group=`,
	apiBaseUrl: `https://${API_HOST}/portal/api/v0/`,
	apiBase: `https://${API_HOST}/portal/`,
	wagtailBase: `https://${API_HOST}/`,
	voRegistrationLink: `https://signup.aai.lifescience-ri.eu/fed/registrar/?vo=elixir&targetnew=https%3A%2F%2Fsignup.aai.lifescience-ri.eu%2Ffed%2Fregistrar%2F%3Fvo%3D${VO_NAME}`,
