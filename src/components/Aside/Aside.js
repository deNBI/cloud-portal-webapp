...
import ***REMOVED*** TabContent, TabPane, Nav, NavItem, NavLink, Progress ***REMOVED*** from 'reactstrap';
import classnames from 'classnames';

class Aside extends Component ***REMOVED***
  ...
  render() ***REMOVED***
    return (
      <aside className="aside-menu">
        <Nav tabs>
          <NavItem>
            <NavLink className=***REMOVED***classnames(***REMOVED*** active: this.state.activeTab === '1' ***REMOVED***)***REMOVED*** onClick=***REMOVED***() => ***REMOVED*** this.toggle('1'); ***REMOVED******REMOVED***>
              <i className="icon-list"></i>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className=***REMOVED***classnames(***REMOVED*** active: this.state.activeTab === '2' ***REMOVED***)***REMOVED*** onClick=***REMOVED***() => ***REMOVED*** this.toggle('2'); ***REMOVED******REMOVED***>
              <i className="icon-speech"></i>
            </NavLink>
          </NavItem>
          <NavItem>
            <NavLink className=***REMOVED***classnames(***REMOVED*** active: this.state.activeTab === '3' ***REMOVED***)***REMOVED*** onClick=***REMOVED***() => ***REMOVED*** this.toggle('3'); ***REMOVED******REMOVED***>
          ...
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              <div className="avatar float-right">
                <img src=***REMOVED***'img/avatars/7.jpg'***REMOVED*** className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
            ...
            <div className="callout callout-primary m-0 py-3">
              ...
              <div className="avatars-stack mt-2">
                ...
                <div className="avatar avatar-xs">
                  <img src=***REMOVED***'img/avatars/8.jpg'***REMOVED*** className="img-avatar" alt="admin@bootstrapmaster.com"/>
                </div>
              </div>
            </div>
            <hr className="mx-3 my-0"/>
