...
export class VolumeOverviewComponent extends AbstractBaseClass implements OnInit, OnDestroy {
	...
	checkAvailableVolumeSpaceForCreation(): ValidatorFn {
		return (control: AbstractControl): { [key: string]: any } | null =>
			control.value > 0 && this.selectedProjectDiskSpaceSum <= this.selectedProjectDiskspaceMax
				? null
	...
	calcDiskSpaceSum(): void {
		this.selectedProjectDiskSpaceSum =
			parseInt(this.diskspace.toString(), 10) + parseInt(this.selectedProjectDiskspaceUsed.toString(), 10)
	}
