...
export class VoService {
		...
		sendMailToProjects(
				...
				return this.http.post<IResponseTemplate>(`${ApiSettings.getApiBaseURL()}voManagers/current/voMail/projects/`,
						{project_ids: projectIds, subject: subject, message: message, adminsOnly: adminsOnly, reply: reply}, {
								withCredentials: true,
						});
		}
