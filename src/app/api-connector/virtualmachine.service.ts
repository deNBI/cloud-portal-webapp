...
export class VirtualmachineService ***REMOVED***
    data: string;
    baseVmUrl = `$***REMOVED***ApiSettings.getApiBaseURL()***REMOVED***vms/';
    ...
    ***REMOVED***
    ...
    getActiveVmsByProject(groupid: string): Observable<VirtualMachine[]> ***REMOVED***
        ...
        return this.http.get<VirtualMachine[]>(`$***REMOVED***ApiSettings.getApiBaseURL()***REMOVED***projects/' + groupid + '/vms/', ***REMOVED***
            withCredentials: true,
        ***REMOVED***).pipe(catchError((error: any) => throwError(error)));
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    attachVolumetoServer(volume_id: string, instance_id: string): Observable<any> ***REMOVED***
        ...
        return this.http.post(`$***REMOVED***ApiSettings.getApiBaseURL()***REMOVED***volumes/' + volume_id + '/action/', params, ***REMOVED***
            withCredentials: true,
            headers: header,
        ***REMOVED***).pipe(catchError((error: any) => throwError(error)));
    ***REMOVED***
    ...
    renameVolume(volume_id: string, new_volume_name: string): Observable<any> ***REMOVED***
        ...
        return this.http.patch(`$***REMOVED***ApiSettings.getApiBaseURL()***REMOVED***volumes/' + volume_id + '/', params, ***REMOVED***
            withCredentials: true,
            headers: header,
        ***REMOVED***).pipe(catchError((error: any) => throwError(error)));
    ...
    ***REMOVED***
    ...
    deleteVolume(volume_id: string): Observable<any> ***REMOVED***
        ...
        return this.http.delete(`$***REMOVED***ApiSettings.getApiBaseURL()***REMOVED***volumes/' + volume_id + '/', ***REMOVED***
            withCredentials: true,
            headers: header,
        ***REMOVED***).pipe(catchError((error: any) => throwError(error)));
    ***REMOVED***
