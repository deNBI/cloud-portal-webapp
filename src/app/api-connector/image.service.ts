...
export class ImageService {
    ...
    getImages(project_id: number): Observable<Image[]> {
        ...
        return this.http.get<Image[]>(this.settings.getApiBaseURL() + 'images/', {
    ...
    getImagesSnapshotsNames(): Observable<any> {
        ...
        return this.http.get<Image[]>(this.settings.getApiBaseURL() + 'snapshots/names/', {
            withCredentials: true,
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    getSnapshot(openstack_id: string): Observable<Image> {
        ...
        return this.http.get<Image>(this.settings.getApiBaseURL() + 'snapshots/' + openstack_id + '/status/', {
            withCredentials: true,
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    getImageTags(): Observable<any> {
        return this.http.get(this.settings.getApiBaseURL() + 'imageTags/', {
            withCredentials: true,
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    addImageTags(imageTag: string, description: string): Observable<any> {
        ...
        return this.http.post(this.settings.getApiBaseURL() + 'imageTags/', params, {
            withCredentials: true,
            headers: header
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    deleteImageTag(imageTag: string): Observable<any> {
        ...
        return this.http.delete(this.settings.getApiBaseURL() + 'imageTags/' + imageTag + '/', {
            withCredentials: true,
            headers: header
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    createSnapshot(snaptshot_instance: string, snapshot_name: string): Observable<any> {
        ...
        return this.http.post(this.settings.getApiBaseURL() + 'snapshots/', params, {
            withCredentials: true,
            headers: header
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    deleteSnapshot(snapshot_id: string): Observable<any> {
        return this.http.delete(this.settings.getApiBaseURL() + 'snapshots/' + snapshot_id + '/', {
            withCredentials: true,
            headers: header
        }).pipe(catchError((error: any) => throwError(error)));
    ...
    getSnapshotsByUser(): Observable<SnapshotModel[]> {
        ...
        return this.http.get<SnapshotModel[]>(this.settings.getApiBaseURL() + 'snapshots/', {
            withCredentials: true,
        }).pipe(catchError((error: any) => throwError(error)));
