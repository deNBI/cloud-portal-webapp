...
export class ApplicationModification {
	...
	public setByApp(app: Application): void {
		...
		if (app.project_application_openstack_project || app.project_application_storage_project) {
			this.object_storage = app.project_application_object_storage
		}
		if (app.project_application_storage_project) {
			this.number_of_buckets = app.project_application_number_of_buckets
		} else {
			this.flavors = []
