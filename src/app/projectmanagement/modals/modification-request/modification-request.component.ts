...
@Component({
    ...
    imports: [FormsModule, AccordionModule, NgFor, NgIf, NgClass, MinAmoutValidatorDirective, IntegerValidatorDirective, FlavorCounterPipe, HasFlavorTypeOrIsNotCustomPipe_1]
})
