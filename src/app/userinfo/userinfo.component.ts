...
@Component({
    ...
    imports: [NgIf, NewsComponent, MaintenanceAlertComponent, NgFor, PublicKeyComponent, FormsModule, ModalModule, NgClass]
})
export class UserInfoComponent implements OnInit {
	 ...
	 */
	dsgvo_text: string =
		'By activating this option, you agree that your preferred e-mail address may be used for the newsletter. ' +
						...
						forkJoin(
							...
							next: (userProjectResult: Application[]) => {
								...
								const group_ids: string[] = this.userProjects
									.filter((pr_app: Application) =>
										pr_app.project_application_statuses.includes(Application_States.APPROVED)
									)
