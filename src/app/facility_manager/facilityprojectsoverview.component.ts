...
@Component({
    ...
    imports: [NgIf, FormsModule, NgFor, TextColorDirective, TextBgColorDirective, BadgeComponent, NgbPagination, InputGroupComponent, ButtonDirective, NgbdSortableHeaderDirective, ApplicationBadgesComponent, NgbHighlight, ModalModule, NgClass, NgSelectComponent, AsyncPipe, HasStatusPipe, HasstatusinlistPipe, InListPipe]
})
