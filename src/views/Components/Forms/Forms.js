...
import ***REMOVED*** Button, ButtonDropdown, DropdownToggle, DropdownMenu, DropdownItem ***REMOVED*** from 'reactstrap';

class Forms extends Component ***REMOVED***
                ...
                <form className="form-horizontal">
                    ...
                    <div className="col-md-12">
                      <div className="input-group">
                        <div className="input-group-btn">
                          <ButtonDropdown isOpen=***REMOVED***this.state.first***REMOVED*** toggle=***REMOVED***() => ***REMOVED*** this.setState(***REMOVED*** first: !this.state.first ***REMOVED***); ***REMOVED******REMOVED***>
                  ...
                  <div className="form-group row">
                    <div className="col-md-12">
                      <div className="input-group">
                        ...
                        <div className="input-group-btn">
                          <ButtonDropdown isOpen=***REMOVED***this.state.second***REMOVED*** toggle=***REMOVED***() => ***REMOVED*** this.setState(***REMOVED*** second: !this.state.second ***REMOVED***); ***REMOVED******REMOVED***>
                            <DropdownToggle caret color="primary">
                              Button Dropdown
                            </DropdownToggle>
                            <DropdownMenu>
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="input-group">
                        <div className="input-group-btn">
                          <ButtonDropdown isOpen=***REMOVED***this.state.third***REMOVED*** toggle=***REMOVED***() => ***REMOVED*** this.setState(***REMOVED*** third: !this.state.third ***REMOVED***); ***REMOVED******REMOVED***>
                        ...
                        <div className="input-group-btn">
                          <ButtonDropdown isOpen=***REMOVED***this.state.fourth***REMOVED*** toggle=***REMOVED***() => ***REMOVED*** this.setState(***REMOVED*** fourth: !this.state.fourth ***REMOVED***); ***REMOVED******REMOVED***>
                            <DropdownToggle caret color="primary">
                              Button Dropdown
                            </DropdownToggle>
                            <DropdownMenu>
