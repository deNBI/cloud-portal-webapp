...
class FontAwesome extends Component ***REMOVED***
  render() ***REMOVED***
    return (
      <div className="animated fadeIn">
  <div className="card" id="new">
    <div className="card-header">20 New Icons in 4.5</div>
  ...
  <div className="card" id="web-application">
    <div className="card-header">Web Application Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="hand">
    <div className="card-header">Hand Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="transportation">
    <div className="card-header">Transportation Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="gender">
    <div className="card-header">Gender Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="file-type">
    <div className="card-header">File Type Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="spinner">
    <div className="card-header">Spinner Icons</div>
    <div className="card-block">
  ...
  <div className="card" id="form-control">
    <div className="card-header">Form Control Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="payment">
    <div className="card-header">Payment Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="chart">
    <div className="card-header">Chart Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="currency">
    <div className="card-header">Currency Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="text-editor">
    <div className="card-header">Text Editor Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="directional">
    <div className="card-header">Directional Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="video-player">
    <div className="card-header">Video Player Icons</div>
    <div className="card-block">
      <div className="row text-center">
  ...
  <div className="card" id="brand">
    <div className="card-header">Brand Icons</div>
    <div className="card-block">
      <div className="alert alert-warning">
        ...
        <a href="https://adblockplus.org/en/bugs" className="alert-link">report an issue with Adblock Plus</a> if you believe this to be
  ...
  <div className="card" id="medical">
    <div className="card-header">Medical Icons</div>
    <div className="card-block">
      <div className="row text-center">
