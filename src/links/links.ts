...
export const WIKI_PRINCIPAL_INVESTIGATOR: string =
	'https://cloud.denbi.de/wiki/portal/allocation/#principal-investigator'
export const WIKI_LINKING_ACCOUNTS: string =
	'https://cloud.denbi.de/wiki/portal/user_information/#link-accounts-to-lifescience-formerly-elixir'
...
export const SCALE_SCRIPT_LINK: string =
...
export const SINGLE_TESTIMONIAL_PAGE_LINK: string =
	'https://cloud.denbi.de/about/testimonials/denbi-biohackathon-spacehack-project/'
