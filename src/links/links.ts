export const WIKI_VOLUME: string = 'https://cloud.denbi.de/wiki/portal/volumes/#mount-a-volume';
export const WIKI_GROUP_INVITATIONS: string = 'https://cloud.denbi.de/wiki/portal/project_overview/#inviting-members';
export const WIKI_SNAPSHOTS: string = 'https://cloud.denbi.de/wiki/portal/snapsho/';
