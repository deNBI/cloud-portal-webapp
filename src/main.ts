...
bootstrapApplication(AppComponent, {
    providers: [
        importProvidersFrom(NgScrollbarModule, BrowserModule, AppRoutingModule, CommonModule, BsDropdownModule.forRoot(), TabsModule.forRoot(), ModalModule.forRoot(), PaginationModule.forRoot(), SharedModuleModule, Angulartics2Module.forRoot(), NgSelectModule, ClipboardModule, TimepickerModule.forRoot(), BsDatepickerModule.forRoot(), AlertModule, MatomoModule.forRoot({
